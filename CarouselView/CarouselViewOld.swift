...
public class CarouselViewOld: UIView {
     ...
     */
    public weak var delegate: CarouselViewDelegateOld?
    ...
    private func commonInit() {
        ...
        let nib = UINib(nibName: "CarouselViewOld", bundle: bundle)
...
extension CarouselViewOld: UICollectionViewDelegate {
...
extension CarouselViewOld: UICollectionViewDataSource {
